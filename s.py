...
UDP_PORT = 2023
#server_socket = socket.sockb                 .  3 0 6  36 6                    zz6\a\kfedsioz\a bvjk,li
# ]\ jesooeet(socket.AF_INET, socket.SOCK_DGRAM)# UDP
...
def create_ips(LAST_NUM):e3iujuy i,dcrfcrqevcoqkelfcjokhbgvjfdqhgfle,yofrt,v .ehqfcqvfrc
